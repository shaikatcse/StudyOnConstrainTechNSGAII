...
import jmetal.experiments.settings.NSGAIIATM_Settings;
import jmetal.experiments.settings.NSGAIISR_Settings;
...
public class ConstrainedProblemsStudy extends Experiment {
  ...
  public void algorithmSettings(String problemName, int problemIndex, Algorithm[] algorithm) throws ClassNotFoundException {
    try {
      ...
      if (!paretoFrontFile_[problemIndex].equals("")) {
        ...
        algorithm[1] = new NSGAIISR_Settings(problemName).configure(parameters[1]);
        algorithm[2] = new NSGAIIATM_Settings(problemName).configure(parameters[2]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    exp.algorithmNameList_ = new String[]{
      "NSGAII", "NSGAIISR", "NSGAIIATM"};
    exp.problemList_ = new String[]{
      "ConstrEx","Tanaka", "Srinivas","Binh2", "Osyczka2", "Golinski"};
    exp.paretoFrontFile_ = new String[]{
      "ConstrEx.pf", "Tanaka.pf", "Srinivas.pf", "Binh2.pf", "Osyczka2.pf", "Golinski.pf"};
    
    exp.indicatorList_ = new String[]{"HV", 	"EPSILON"};

    int numberOfAlgorithms = exp.algorithmNameList_.length;

    exp.experimentBaseDirectory_ = "C:\\Users\\shaik\\eclipse-workspace\\StudyOnConstraintHandling\\ExpData\\" + exp.experimentName_;
    exp.paretoFrontDirectory_ = "C:\\Users\\shaik\\eclipse-workspace\\StudyOnConstraintHandling\\ExpData\\ParetoFronts";
   ...
   /* Friedman test = new Friedman(exp);
    ...
    problems = new String[]      {"ConstrEx","Tanaka", "Srinivas","Binh2", "Osyczka2"}; 
