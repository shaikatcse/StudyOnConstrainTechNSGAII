...
import jmetal.metaheuristics.nsgaIIATM.NSGAIIATM;
 ...
 */
public class NSGAIIATM_Settings extends Settings {
   ...
   * Constructor
   */
  public NSGAIIATM_Settings(String problem) {
    super(problem) ;
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new NSGAIIATM(problem_) ;
