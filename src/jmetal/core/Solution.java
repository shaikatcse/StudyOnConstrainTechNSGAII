...
public class Solution implements Serializable {  
  ...
  private final double[] normalizedObjective_;
  
  //for SR
  private final double[] SRdistance_;
  private final double[] SRPenalty_;
  ...
  //for atm
    SRdistance_                     = new double[numberOfObjectives]; 
    SRPenalty_                     = new double[numberOfObjectives]; 
  ...
  public Solution(Problem problem) throws ClassNotFoundException{
    ...
    SRdistance_                     = new double[numberOfObjectives_]; 
    SRPenalty_                     = new double[numberOfObjectives_]; 
  ...
  public Solution(Solution solution) {            
    ...
    convertedObjective_          = new double[solution.getNumberOfObjectives()];
    normalizedObjective_          = new double[solution.getNumberOfObjectives()];
    
    SRdistance_                     = new double[solution.getNumberOfObjectives()]; 
    SRPenalty_                     = new double[solution.getNumberOfObjectives()]; 
...
public double getSRdistance(int i) {
	return SRdistance_[i];
}

public void setSRDistance(double value, int obj) {
	SRdistance_[obj] = value;
}


public double getSRPenalty(int i) {
	return SRPenalty_[i];
}

public void setSRPenalty(double value, int obj) {
	SRPenalty_[obj] = value;
}
